...
export class Monitoring extends React.Component {
  ...
  _startPollingData() {
    this._pollDataInterval = setInterval(() => this._updateUsage(), 500000);
